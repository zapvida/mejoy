...
export const TREATMENT_TRACKS: TreatmentTrackContent[] = [
  {
    ...
    estimate: 'Partindo de 100 kg, isso pode representar algo perto de 15 a 21 kg.',
    safety:
      'Pede avaliacao medica, subida gradual de dose e checagem seria de tolerancia e contraindicacoes.',
    bestFor: 'Costuma entrar quando a meta e mais ambiciosa ou quando o caso pede mais potencia.',
  ...
  },
  {
    ...
    estimate: 'Partindo de 100 kg, isso costuma equivaler a algo perto de 10 a 15 kg.',
    safety:
  ...
  },
  {
    ...
    estimate: 'Partindo de 100 kg, isso pode representar algo perto de 4 a 8 kg.',
    safety:
