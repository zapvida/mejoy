...
export const TREATMENT_TRACKS: TreatmentTrackContent[] = [
  {
    ...
    subtitle: 'Injetavel semanal para quando o medico busca a resposta mais forte e previsivel.',
  ...
  },
  {
    ...
    subtitle: 'Injetavel semanal forte, previsivel e com base clinica muito consolidada.',
    format: 'Injetavel semanal',
    potency: 'Potencia alta',
    certainty: 'Evidencia muito robusta',
  ...
  },
  {
    ...
    shortTitle: 'Contrave',
    badge: 'Opcao oral',
    subtitle: 'Comprimido oral para casos em que uma trilha sem injetavel pode fazer mais sentido.',
  ...
  },
  {
    ...
    subtitle: 'Trilha sem pressa para fechar um principio ativo quando o caso pede mais leitura clinica.',
