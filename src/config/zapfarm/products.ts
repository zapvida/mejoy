...
export const ZAPFARM_PRODUCTS: Record<string, ZapfarmProductConfig> = {
  emagrecimento: {
    slug: 'emagrecimento',
    name: 'Programa Médico para Obesidade e Saúde Metabólica',
    displayName: 'MeJoy Emagrecimento',
    commercialName: 'MeJoy Emagrecimento',
    protocolTitle: 'Programa médico para obesidade e saúde metabólica',
    category: 'Metabolismo',
    description: 'Jornada médica baseada em evidência para obesidade e saúde metabólica, com acompanhamento multiprofissional e medicação apenas quando indicada',
    shortDescription: 'Tratamento médico para obesidade com acompanhamento multiprofissional e conduta individualizada',
    ...
    plans: {
      basico: {
        ...
        description: `Entrada clínica segura com avaliação médica, check-up, psicologia e app Essential. ${emagPreco.basico.priceDetail}`,
        features: [
          '1 consulta com endocrinologista ou nutrólogo',
          '1 retorno clínico após o check-up',
          '1 consulta com psicóloga para aderência',
          'App MeJoy Essential com timeline, status de prescrição e agenda',
          'Medicação apenas quando houver indicação médica',
        ],
      },
      completo: {
        id: 'completo',
        ...
        description: `Tempo clínico suficiente para consolidar aderência, ajustar conduta e acompanhar evolução real. ${emagPreco.completo.priceDetail}`,
        features: [
          'Tudo do plano de 1 mês',
          '1 consulta com nutricionista',
          '1 retorno adicional com especialista',
          'App MeJoy Plus com tarefas, lembretes, evolução e trilha educacional',
          'Ajustes clínicos ao longo de 3 meses conforme resposta e tolerância',
        ],
        recommended: true,
      },
      premium: {
        ...
        description: `Continuidade premium com time nomeado, triagem 24/7 e manutenção da jornada. ${emagPreco.premium.priceDetail}`,
        features: [
          'Tudo do plano de 3 meses',
          'App MeJoy Full com a jornada completa liberada',
          'Linha oficial do programa com roster médico nomeado e triagem 24/7',
          'Escalonamento imediato para o ZapVida em nova dor ou urgência',
          'Follow-up prioritário e manutenção da jornada por 6 meses',
        ],
      },
    },
    ...
    lpac: {
      hero: {
        headline: 'Programa médico para obesidade e saúde metabólica',
        subheadline: 'Avaliação médica baseada em evidência, acompanhamento multiprofissional e medicação apenas quando houver indicação clínica.',
        ctaText: 'Verificar minha elegibilidade clínica',
        bullets: [
          { icon: '🩺', text: 'Tratamento médico individualizado' },
          { icon: '🔬', text: 'Baseado em evidências revisadas' },
          { icon: '🚚', text: 'Entrega e continuidade assistencial quando houver cobertura' },
          { icon: '🧑‍⚕️', text: 'Acompanhamento multiprofissional no ecossistema TecMed' },
        ],
      },
      eligibility: {
        for: [
      ...
      howItWorks: [
        {
          ...
          description: 'Responda à triagem e organize seus dados de saúde para avaliar elegibilidade com mais segurança',
        },
        {
          step: 2,
          title: 'Relatório com próxima melhor ação',
          description: 'Receba uma leitura inicial do seu perfil e veja se o melhor próximo passo é consulta, check-up ou continuidade de tratamento',
        },
        {
          step: 3,
          title: 'Escolha a duração do programa',
          description: 'Selecione 1, 3 ou 6 meses e deixe a molécula final para a avaliação clínica, sem promessa automática de prescrição',
        },
        {
          step: 4,
          title: 'Tratamento e acompanhamento',
          description: 'Quando houver indicação e cobertura, a medicação chega até você e a jornada continua com MeJoy, ZapFarm e ZapVida integrados',
        },
      ],
      benefits: [
        {
      ...
      faq: [
        ...
        },
        {
          ...
          answer: 'A resposta varia conforme o quadro clínico, adesão, alimentação, sono, atividade física e medicação quando indicada. Em geral, as primeiras mudanças aparecem nas semanas iniciais, mas a avaliação correta é longitudinal.',
        },
        {
        ...
        {
          question: 'E se a medicação esperada não for indicada para mim?',
          answer: 'A conduta final é sempre médica. Se a molécula inicialmente desejada não for indicada, você pode converter para um protocolo clínico alternativo ou solicitar reembolso integral antes do envio da medicação.',
        },
        {
        ...
        },
        {
          ...
          answer: 'O programa aceita pacientes do Brasil inteiro. Onde houver cobertura farmacêutica ativa, a cotação e a entrega seguem normalmente; em regiões ainda em abertura operacional, mantemos a jornada clínica e entramos com concierge ou lista de espera logística.',
        },
      ],
    },
    
    seo: {
      title: 'Programa médico para obesidade e saúde metabólica | MeJoy',
      description: 'Programa médico com triagem, avaliação baseada em evidência, acompanhamento multiprofissional e continuidade assistencial para obesidade e saúde metabólica.',
      keywords: ['obesidade tratamento', 'saúde metabólica', 'emagrecimento médico', 'endocrinologista online', 'nutrólogo online', 'tratamento para obesidade', 'programa médico emagrecimento', 'MeJoy emagrecimento'],
    },
  },
