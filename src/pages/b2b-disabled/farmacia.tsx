      ...
      <main className="min-h-screen bg-bg text-fg">
        ...
        <div className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-10">
                <div className="text-center lg:text-left space-y-4 px-2 sm:px-8">
                  ...
                  >
                    Sua farmácia pode ser referência em saúde preventiva.
                  </motion.h1>
                  <h2 className="text-xl font-bold text-white/90 mb-4">
                    Ofereça um check-up digital gratuito para atrair, fidelizar e cuidar mais dos seus clientes.
                  </h2>
                  <p className="text-lg text-white/70 mb-2">
                    Triagem com inteligência artificial para entender sintomas e riscos. Sem custo, sem filas, direto do balcão.
                  </p>
                  <p className="text-lg text-white/70 mb-4">
                    A ferramenta perfeita para diferenciar sua farmácia no atendimento.
                  </p>
                  <Button
                  ...
                  >
                    ...
                    <span className="relative z-10 inline-flex items-center gap-2">
                      ...
                      {versaoA ? 'Quero Oferecer na Minha Farmácia' : 'Solicitar Demonstração Gratuita'}
                    </span>
                  </Button>
                </div>
          ...
          <section className="pt-12 sm:pt-16 container-center">
            <h2 className="text-3xl font-bold mb-10 text-center">Como funciona na farmácia?</h2>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-bg border border-border text-fg rounded-xl shadow-lg mt-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <a
                href="https://wa.me/5547999009923?text=quero%20zapfarm%20na%20minha%20farmacia"
                target="_blank"
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black/10 backdrop-blur-sm">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <Button onClick={handleTriagem} className="w-full sm:w-auto mt-4 text-lg">
                🚀 Quero Fidelizar com Check-up Digital
              </Button>
            </div>
          </section>
