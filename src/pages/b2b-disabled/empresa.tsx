...
export default function Home() {
  ...
  const [versaoA, setVersaoA] = useState(true);

  useEffect(() => {
    setVersaoA(Math.random() < 0.5);
  }, []);
  ...
  return (
    <>
      <Head>
        <title>MeJoy - Triagem de Saúde com IA</title>
      ...
      <main className="min-h-screen bg-bg text-fg">
        ...
        <div className="relative z-10">
                ...
                <div className="text-center lg:text-left space-y-4 px-2 sm:px-8">
                  {versaoA ? (
                    <>
                      <motion.h1 initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
                        ...
                        Está tudo bem... Mas você sente que algo está errado?
                      </motion.h1>
                      <h2 className="text-xl font-bold text-white/90 mb-4">
                        Descubra agora o que seu corpo está tentando te mostrar.
                      </h2>
                      <p className="text-lg text-white/70 mb-2">
                        Em poucos minutos, a IA da saúde te ajuda a entender sintomas, riscos e o que fazer a partir de hoje.
                      </p>
                      <p className="text-lg text-white/70 mb-4">
                        Sem filas. Sem exames. Sem enrolação.
                      </p>
                    </>
                  ) : (
                    <>
                      <motion.h1 initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
                        className="text-4xl md:text-6xl font-extrabold mb-6">
                        Um teste gratuito para entender sua saúde por completo.
                      </motion.h1>
                      <h2 className="text-xl font-bold text-white/90 mb-4">
                        Um relatório claro com base em ciência e inteligência artificial.
                      </h2>
                      <p className="text-lg text-white/70 mb-2">
                        Em apenas 5 minutos, você descobre sinais, causas e caminhos de tratamento possíveis.
                      </p>
                      <p className="text-lg text-white/70 mb-4">
                        Simples, confidencial e feito para você.
                      </p>
                    </>
                  )}
                  <Button
                  ...
                  >
                    ...
                    <span className="relative z-10 inline-flex items-center gap-2">
                      ...
                      {versaoA ? 'Fazer Triagem Gratuita Agora' : 'Começar Minha Avaliação Gratuita'}
                    </span>
                  </Button>
                </div>
          ...
          {/* Empresas que valorizam a saúde dos colaboradores */}
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-bg border border-border text-fg rounded-xl shadow-lg mt-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <h2 className="text-3xl font-bold">🏢 Para empresas que cuidam de verdade dos seus colaboradores</h2>
              <p className="text-white/80 text-lg">
                Reduza faltas, aumente a produtividade e mostre que sua empresa se importa de verdade com as pessoas.
              </p>
              <p className="text-white/70 text-base">
                O MeJoy oferece triagens inteligentes com relatórios personalizados que ajudam a prevenir doenças e promovem qualidade de vida no ambiente de trabalho.
              </p>
              <p className="text-white/60 text-sm">
                RHs, gestores e líderes já estão adotando essa solução como um benefício corporativo inovador e de baixo custo.
              </p>
              <a
                href="https://wa.me/5547999009923?text=quero%20levar%20zapfarm%20para%20minha%20empresa"
                target="_blank"
          ...
          <a
            ...
            title="Fale com um médico agora"
          >
