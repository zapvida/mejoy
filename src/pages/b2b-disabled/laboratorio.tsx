        ...
        <div className="relative z-10">
                ...
                <div className="text-center lg:text-left space-y-4 px-2 sm:px-8">
                  {versaoA ? (
                    <>
                      <motion.h1 initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
                        ...
                        Eleve a experiência do seu laboratório com inteligência artificial
                      </motion.h1>
                      <h2 className="text-xl font-bold text-white/90 mb-4">
                        Ofereça diagnósticos digitais em minutos para seus pacientes ou parceiros.
                      </h2>
                      <p className="text-lg text-white/70 mb-2">
                        Transforme seus atendimentos com relatórios claros, personalizados e baseados em ciência.
                      </p>
                      <p className="text-lg text-white/70 mb-4">
                        Mais valor, mais precisão, mais fidelização.
                      </p>
                    </>
                  ) : (
                    <>
                      ...
                      <p className="text-lg text-white/70 mb-4">
                        Inovação que gera fidelização e reconhecimento.
                      </p>
                    </>
                  )}
                  <Button
                  ...
                  >
                    ...
                    <span className="relative z-10 inline-flex items-center gap-2">
                      ...
                      Começar Triagem de Exemplo Agora
                    </span>
                  </Button>
                </div>
          ...
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-bg border border-border text-fg rounded-xl shadow-lg mt-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <h2 className="text-3xl font-bold">⚗️ Torne seu laboratório referência em tecnologia e cuidado</h2>
