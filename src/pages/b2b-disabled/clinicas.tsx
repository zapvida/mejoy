...
export default function Home() {
  ...
  const etapas = [
    ...
    { icon: '👨‍⚕️', title: 'Consulte um médico', desc: 'Fale com um médico em até 5 minutos, com base no seu relatório.' },
  ];
    ...
    <>
      ...
      <main className="min-h-screen bg-bg text-fg">
        ...
        <div className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center justify-center gap-10">
                <div className="text-center lg:text-left space-y-4 px-2 sm:px-8">
                  ...
                  >
                    <span className="absolute inset-0 bg-brand/10 blur-md opacity-70 animate-pulse rounded-full" />
          ...
          <section className="pt-12 sm:pt-16 container-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {etapas.map((item, idx) => (
                <motion.div
                  key={item.title}
                  className="card-premium text-center hover:scale-105 transition duration-300"
          ...
          {/* Clínicas Médicas: Otimize seu Atendimento com IA */}
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-bg border border-border text-fg rounded-xl shadow-lg mt-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <h2 className="text-3xl font-bold">🏥 Sua clínica mais produtiva em minutos</h2>
              <p className="text-white/80 text-lg">
                Reduza o tempo das consultas, ofereça um atendimento mais completo e conquiste mais pacientes com inteligência artificial.
              </p>
              <p className="text-white/70 text-base">
                A anamnese é feita antes mesmo do paciente entrar no consultório. Você ganha tempo e aumenta a precisão clínica — sem alterar sua rotina.
              </p>
              <a
                href="https://wa.me/5547999009923?text=Quero%20usar%20o%20Alloe%20Health%20na%20minha%20clínica"
                target="_blank"
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                  {[
                    ...
                    <Image key={alt} src={src} alt={alt} width={100} height={60} unoptimized />
                  ))}
                </div>
              </div>
            </div>
