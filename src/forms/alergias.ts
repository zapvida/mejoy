...
export const perguntasAlergias: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Alergias & Intolerâncias',
    description: 'Rinite, alimentos, medicamentos. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Alergologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Espirros","Coriza","Coceira nos olhos","Tosse","Falta de ar"],
    required: true,
    prioridade: 'alta',
  ...
  
  {
    type: 'select',
    name: 'reacao_severa',
    label: 'Você apresenta reação alérgica severa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'dificuldade_respirar',
    label: 'Você tem dificuldade para respirar?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  ...
  {
    type: 'select',
    name: 'inchaço_garganta',
    label: 'Você apresenta inchaço na garganta?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
