...
export const perguntasTireoide: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde da Tireoide',
    description: 'Hipo/hiper, nódulos. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Endocrinologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Sede excessiva","Urina frequente","Fome excessiva","Perda de peso","Ganho de peso","Cansaço"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'perda_peso_rapida',
    label: 'Você perdeu peso rapidamente sem motivo?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'sede_excessiva',
    label: 'Você sente sede excessiva?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  },
  {
    ...
    label: 'Você urina com muita frequência?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
