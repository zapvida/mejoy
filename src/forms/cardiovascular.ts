...
export const perguntasCardiovascular: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Cardiovascular',
    description: 'Pressão, palpitações, risco cardíaco. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Cardiologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor no peito","Palpitações","Falta de ar","Cansaço excessivo","Tontura","Desmaio"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'dor_toracica_sudita',
    label: 'Você sente dor no peito súbita e intensa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'desmaio',
    label: 'Você já desmaiou recentemente?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  ...
  {
    type: 'select',
    name: 'falta_ar_repouso',
    label: 'Você sente falta de ar mesmo em repouso?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
