...
export const perguntasAuditiva: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Auditiva',
    description: 'Perda, zumbido, acufenos. Responda em ~3-4 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Otorrinolaringologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Perda auditiva","Zumbido","Dor de ouvido","Tontura","Náusea"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'perda_auditiva_sudita',
    label: 'Você perdeu a audição subitamente?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
