...
export const perguntasidoso: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde do Idoso',
    description: 'Quedas, fragilidade, memória. Responda em ~5-6 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Geriatria.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Quedas","Esquecimento","Dificuldade para caminhar","Isolamento","Depressão"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'confusao_mental',
    label: 'Você apresenta confusão mental?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
