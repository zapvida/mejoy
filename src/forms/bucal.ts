...
export const perguntasBucal: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Bucal',
    description: 'Gengiva, bruxismo, cáries. Responda em ~3-4 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Odontologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor de dente","Sangramento gengival","Sensibilidade","Mau hálito","Dentes soltos"],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'inchaço_face',
    label: 'Você apresenta inchaço no rosto?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
