...
export const perguntasHepatica: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde do Fígado',
    description: 'Esteatose, hepatites. Responda em ~3-4 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Gastroenterologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor abdominal","Náusea","Vômito","Diarréia","Constipação","Azia"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'dor_abdominal_intensa',
    label: 'Você sente dor abdominal intensa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
