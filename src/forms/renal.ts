...
export const perguntasrenal: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Renal',
    description: 'Pedras, função renal. Responda em ~3-4 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Nefrologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor lombar","Alteração na urina","Inchaço","Pressão alta","Cansaço"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'dor_lombar_intensa',
    label: 'Você sente dor lombar intensa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'urina_sangue',
    label: 'Você apresenta sangue na urina?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
