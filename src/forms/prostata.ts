...
export const perguntasProstata: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde da Próstata',
    description: 'LUTS, PSA, hiperplasia. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Urologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dificuldade para urinar","Dor ao urinar","Urgência urinária","Incontinência","Dor pélvica"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'retencao_urinaria',
    label: 'Você não consegue urinar?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
