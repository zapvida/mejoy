...
export const perguntasVitalidade: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Vitalidade & Energia',
    description: 'Fadiga, mitocôndria, energia. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
