...
export const perguntasLongevidade: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Longevidade & Anti-Aging',
    description: 'Hábitos que retardam o declínio. Responda em ~5-6 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Medicina Preventiva.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Cansaço","Falta de energia","Dificuldade para dormir","Estresse","Ansiedade"],
    required: true,
    prioridade: 'alta',
