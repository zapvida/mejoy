...
export const perguntasSexual: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Sexual',
    description: 'DE, libido, ISTs (educativo). Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Sexologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Disfunção erétil","Baixa libido","Dor na relação","Ansiedade","Estresse"],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'sangramento',
    label: 'Você apresenta sangramento?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
