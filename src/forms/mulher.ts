...
export const perguntasmulher: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde da Mulher',
    description: 'SOP, endometriose, menopausa. Responda em ~5-6 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Ginecologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor pélvica","Alteração menstrual","Corrimento","Dor na relação","Irritação"],
    required: true,
    prioridade: 'alta',
  ...
  
  {
    ...
    label: 'Você apresenta sangramento excessivo?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'dor_pelvica_intensa',
    label: 'Você sente dor pélvica intensa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
