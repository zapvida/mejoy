...
export const perguntasmama: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde da Mama',
    description: 'Dor, nódulos, rastreio. Responda em ~3-4 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Mastologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor na mama","Nódulo","Alteração na pele","Secreção","Inchaço"],
    required: true,
    prioridade: 'alta',
  ...
  
  {
    type: 'select',
    name: 'nodulo_duro',
    label: 'Você sente um nódulo duro?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'alteracao_pele',
    label: 'Você apresenta alteração na pele?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  ...
  {
    type: 'select',
    name: 'secrecao_sangue',
    label: 'Você apresenta secreção com sangue?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
