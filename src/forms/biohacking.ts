...
export const perguntasBiohacking: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Biohacking & Performance',
    description: 'Rotinas de alta performance. Responda em ~5-6 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Medicina Funcional.',
  },
  {
    type: 'multiselect',
