...
export const perguntasTrabalhador: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde do Trabalhador',
    description: 'LER, ergonomia, burnout. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Medicina do Trabalho.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor nas costas","Dor no pescoço","Estresse","Cansaço","Irritabilidade"],
    required: true,
    prioridade: 'alta',
