...
export const perguntasDiabetesMetabolismo: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Diabetes e Metabolismo',
    description: 'Glicemia, resistência insulínica. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
