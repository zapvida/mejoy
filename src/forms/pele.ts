...
export const perguntaspele: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde da Pele',
    description: 'Acne, eczema, psoríase. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Dermatologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Coceira","Vermelhidão","Descamação","Feridas","Manchas"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'ferida_nao_cicatriza',
    label: 'Você apresenta ferida que não cicatriza?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'mancha_escura',
    label: 'Você apresenta mancha escura?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  ...
  {
    type: 'select',
    name: 'coceira_intensa',
    label: 'Você apresenta coceira intensa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
