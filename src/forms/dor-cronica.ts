...
export const perguntasDorCronica: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Dor Crônica & Fibromialgia',
    description: 'Mapa de dor e gatilhos. Responda em ~5-6 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Reumatologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Dor nas articulações","Rigidez matinal","Inchaço","Dificuldade para se mover","Fadiga"],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'inchaço_severo',
    label: 'Você apresenta inchaço severo?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
