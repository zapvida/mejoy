...
export const perguntasCrianca: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde da Criança',
    description: 'Sono, alimentação, marcos. Responda em ~5-6 min. Geramos um plano claro com prioridades e próximos passos.',
    justification: 'Leva de 5-6 min para completar.',
  },
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Pediatria.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Febre","Choro excessivo","Dificuldade para dormir","Falta de apetite","Irritabilidade"],
    required: true,
    prioridade: 'alta',
  ...
  
  {
    type: 'select',
    name: 'febre_alta',
    label: 'Você está com febre alta?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    ...
    label: 'Você apresenta vômito persistente?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
