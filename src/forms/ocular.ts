...
export const perguntasocular: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Ocular',
    description: 'Visão, glaucoma, catarata. Responda em ~3-4 min. Geramos um plano claro com prioridades e próximos passos.',
    justification: 'Leva de 3-4 min para completar.',
  },
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Oftalmologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Visão embaçada","Dor nos olhos","Sensibilidade à luz","Olhos secos","Dor de cabeça"],
    required: true,
    prioridade: 'alta',
  ...
  {
    type: 'select',
    name: 'perda_visao_sudita',
    label: 'Você perdeu a visão subitamente?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'dor_intensa',
    label: 'Você sente dor intensa que não melhora?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  },
  {
    type: 'select',
    name: 'fotofobia',
    label: 'Você apresenta sensibilidade extrema à luz?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
