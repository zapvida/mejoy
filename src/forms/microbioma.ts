...
export const perguntasMicrobioma: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Intestinal & Microbioma',
    description: 'SIBO, permeabilidade, flora. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
