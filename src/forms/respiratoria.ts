...
export const perguntasRespiratoria: Step[] = [
  {
    type: 'intro',
    name: 'intro',
    label: 'Saúde Respiratória',
    description: 'Asma, DPOC, apneia do sono. Responda em ~4-5 min. Geramos um plano claro com prioridades e próximos passos.',
  ...
  // Sintomas principais
  {
    ...
    description: 'Identifique os sintomas relacionados à Pneumologia.',
  },
  {
    type: 'multiselect',
    name: 'sintomas_principais',
    label: 'Quais sintomas você apresenta?',
    options: ["Tosse","Falta de ar","Chiado","Dor no peito","Cansaço"],
    required: true,
    prioridade: 'alta',
  ...
  
  {
    type: 'select',
    name: 'chiado_severo',
    label: 'Você apresenta chiado severo?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
  ...
  },
  {
    type: 'select',
    name: 'cianose',
    label: 'Você apresenta coloração azulada?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
  ...
  {
    type: 'select',
    name: 'saturacao_baixa',
    label: 'Sua saturação está baixa?',
    options: ['Sim', 'Não'],
    required: true,
    prioridade: 'alta',
    categoriaIA: 'red_flags',
