...
const PREMIUM_SONO: Record<string, { hero_benefit: string; shortBenefit: string; description_md: string; faq: string; seoDescription: string }> = {
  'MEJOY-0152': {
    ...
    seoDescription: 'GABA 200 mg para relaxamento e sono. Dose inicial, 60 cápsulas. Fórmula manipulada. Entrega nacional. MeJoy.',
  },
  'MEJOY-0153': {
    ...
    seoDescription: 'GABA 400 mg para sono e relaxamento profundo. Dose concentrada, 60 cápsulas. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0154': {
    ...
    seoDescription: 'Melatonina 3 mg para regular o ciclo do sono. 100 cápsulas. Dose de referência. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0155': {
    ...
    seoDescription: 'Melatonina 5 mg, 100 cápsulas. Dose reforçada para sono. Fórmula manipulada. Entrega nacional. MeJoy.',
  },
  'MEJOY-0156': {
    ...
    seoDescription: 'Melatonina 5 mg, 30 cápsulas. Para teste ou viagem. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0157': {
    ...
    seoDescription: 'Mulungu 200 mg para relaxamento e sono. Planta brasileira. 60 cápsulas. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0158': {
    ...
    seoDescription: 'Passiflora 200 mg para sono leve e relaxamento. Efeito suave. 60 cápsulas. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0159': {
    ...
    seoDescription: 'Proslepp 130 mg — melatonina natural da cereja. Para indução do sono. 60 cápsulas. MeJoy.',
  },
  'MEJOY-0160': {
    ...
    seoDescription: 'Relora 250 mg para estresse e sono. Magnolia + phellodendron. 60 cápsulas. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0161': {
    ...
    seoDescription: 'Relora 500 mg para estresse e sono. Dose concentrada. 30 cápsulas. Fórmula manipulada. MeJoy.',
  },
  'MEJOY-0162': {
    ...
    seoDescription: 'Valeriana 100 mg para indução do sono. Planta com evidência científica. 60 cápsulas. MeJoy.',
  },
};
