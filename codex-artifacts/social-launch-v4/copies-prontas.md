...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/01-direcao-medica.jpg`
- Título na arte: `Emagrecer com direção médica`
- Subtítulo na arte: `Clareza, plano individual e acompanhamento para construir resultado sustentável.`
- CTA na arte: `Começar minha triagem`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/02-seu-caso-primeiro.jpg`
- Título na arte: `Seu caso vem antes da solução`
- Subtítulo na arte: `A triagem organiza histórico, rotina e objetivos antes de qualquer decisão.`
- CTA na arte: `Entender meu caso`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/03-criterio-clinico.jpg`
- Título na arte: `Toda conduta começa com critério`
- Subtítulo na arte: `Avaliação clínica antes de qualquer ajuste, prescrição ou próximo passo.`
- CTA na arte: `Ver como funciona`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/04-acompanhamento-real.jpg`
- Título na arte: `Você não precisa sustentar isso sozinho(a)`
- Subtítulo na arte: `Com acompanhamento certo, a rotina pesa menos e a constância fica mais viável.`
- CTA na arte: `Conhecer o acompanhamento`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/05-vida-real.jpg`
- Título na arte: `Seu plano precisa
caber na rotina`
- Subtítulo na arte: `Resultado sustentável nasce de adesão, ajustes e estratégia possível.`
- CTA na arte: `Buscar constância`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/06-historias-reais.jpg`
- Título na arte: `Histórias reais,
sem exagero`
- Subtítulo na arte: `Cada pessoa responde de um jeito. O que importa é cuidado com honestidade.`
- CTA na arte: `Ver histórias reais`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/07-sustentabilidade.jpg`
- Título na arte: `Resultado bom é o que continua`
- Subtítulo na arte: `Menos ansiedade por pressa. Mais consistência para manter progresso com responsabilidade.`
- CTA na arte: `Entender o processo`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/08-clareza-e-leveza.jpg`
- Título na arte: `Mais clareza. Menos culpa.`
- Subtítulo na arte: `Quando o processo faz sentido, cuidar da saúde deixa de ser guerra diária.`
- CTA na arte: `Cuidar com clareza`
...
- Imagem: `codex-artifacts/social-launch-v4/final-posts/09-comecar-com-clareza.jpg`
- Título na arte: `Comece pelo que faz sentido para você`
- Subtítulo na arte: `A triagem ajuda a entender seu momento com privacidade e direção inicial.`
- CTA na arte: `Fazer minha triagem`
