...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/01-comece-com-direcao.jpg`
- Título: `Comece com direção`
- Subtítulo: `Triagem, avaliação médica e acompanhamento para cuidar do emagrecimento com mais clareza.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/02-seu-caso-vem-primeiro.jpg`
- Título: `Seu caso vem primeiro`
- Subtítulo: `A triagem ajuda a entender histórico, rotina e objetivos antes de qualquer decisão.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/03-criterio-antes-de-tudo.jpg`
- Título: `Critério antes de tudo`
- Subtítulo: `Toda conduta responsável começa com avaliação clínica individual.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/04-voce-nao-esta-sozinho.jpg`
- Título: `Você não está sozinho(a)`
- Subtítulo: `Com acompanhamento certo, a constância fica mais leve e mais possível.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/05-cuidar-tambem-e-rotina.jpg`
- Título: `Cuidar também é rotina`
- Subtítulo: `Resultado sustentável nasce do que cabe na vida real.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/06-historias-reais-sem-exagero.jpg`
- Título: `Histórias reais, sem exagero`
- Subtítulo: `Cada pessoa responde de um jeito. O que importa é cuidado com honestidade.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/07-resultado-que-continua.jpg`
- Título: `Resultado que continua`
- Subtítulo: `Mais consistência, menos ansiedade por pressa.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/08-mais-clareza-menos-culpa.jpg`
- Título: `Mais clareza. Menos culpa.`
- Subtítulo: `Quando o processo faz sentido, cuidar da saúde deixa de ser guerra diária.`
...
- Imagem: `codex-artifacts/social-launch-v3/final-posts/09-entender-vem-antes-de-decidir.jpg`
- Título: `Entender vem antes de decidir`
- Subtítulo: `O primeiro passo é descobrir o que faz sentido para você hoje.`
