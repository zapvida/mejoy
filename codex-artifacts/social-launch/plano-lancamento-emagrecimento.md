...
- Arquivo final: `codex-artifacts/social-launch/final-posts/01-emagrecimento-com-criterio-medico.jpg`
- Fonte: `public/images/emagrecimento/medvi/hero-main.webp`
- Categoria: `LANÇAMENTO`
- Título na arte: `Emagrecimento com critério médico`
- Subtítulo na arte: `Triagem inteligente, plano individual e foco em resultado sustentável.`
- CTA sugerido: `Comece pela triagem`
- Objetivo: Apresentação da marca e promessa central.
- Impulsionar depois: `sim`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/02-comece-entendendo-o-seu-caso.jpg`
- Fonte: `public/images/emagrecimento/medvi/journey-triagem.avif`
- Categoria: `TRIAGEM`
- Título na arte: `Comece entendendo o seu caso`
- Subtítulo na arte: `Uma triagem online clara ajuda a organizar próximos passos com mais segurança.`
- CTA sugerido: `Entender meu caso`
- Objetivo: Educar sobre o primeiro passo do funil.
- Impulsionar depois: `sim`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/03-nada-e-decidido-no-automatico.jpg`
- Fonte: `public/images/emagrecimento/medvi/journey-consulta.avif`
- Categoria: `SEGURANÇA`
- Título na arte: `Nada é decidido no automático`
- Subtítulo na arte: `A avaliação médica vem antes de qualquer conduta, ajuste ou prescrição.`
- CTA sugerido: `Ver como funciona`
- Objetivo: Construir confiança e reduzir objeção de segurança.
- Impulsionar depois: `sim`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/04-voce-nao-precisa-fazer-isso-sozinho.jpg`
- Fonte: `public/images/emagrecimento/medvi/support-whatsapp.avif`
- Categoria: `SUPORTE`
- Título na arte: `Você não precisa fazer isso sozinho(a)`
- Subtítulo na arte: `Nossa equipe acompanha rotina, dúvidas e próximos passos ao longo do processo.`
- CTA sugerido: `Conhecer o suporte`
- Objetivo: Reforçar valor de acompanhamento e adesão.
- Impulsionar depois: `não`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/05-seu-plano-precisa-caber-na-vida-real.jpg`
- Fonte: `public/images/emagrecimento/medvi/metabolism-habits.avif`
- Categoria: `ROTINA`
- Título na arte: `Seu plano precisa caber na vida real`
- Subtítulo na arte: `Constância, adesão e ajustes bem feitos valem mais do que pressa.`
- CTA sugerido: `Buscar constância`
- Objetivo: Conectar com dor de aderência e rotina.
- Impulsionar depois: `não`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/06-pessoas-reais-evolucao-real.jpg`
- Fonte: `public/images/emagrecimento/medvi/reviews-01.webp`
- Categoria: `HISTÓRIAS REAIS`
- Título na arte: `Pessoas reais. Evolução real.`
- Subtítulo na arte: `Com identidade preservada, cuidado individual e expectativas mais honestas.`
- CTA sugerido: `Ver histórias reais`
- Objetivo: Prova social com tom humano e preservação de identidade.
- Impulsionar depois: `não`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/07-resultado-sustentavel-e-o-que-continua.jpg`
- Fonte: `public/images/emagrecimento/medvi/reviews-04.avif`
- Categoria: `RESULTADOS`
- Título na arte: `Resultado sustentável é o que continua`
- Subtítulo na arte: `Sem promessa milagrosa. Com acompanhamento responsável e metas possíveis.`
- CTA sugerido: `Entender o processo`
- Objetivo: Posicionar contra promessas milagrosas e a favor de sustentabilidade.
- Impulsionar depois: `sim`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/08-quando-o-processo-faz-sentido-a-rotina-muda.jpg`
- Fonte: `public/images/emagrecimento/medvi/reviews-03.avif`
- Categoria: `BEM-ESTAR`
- Título na arte: `Quando o processo faz sentido, a rotina muda`
- Subtítulo na arte: `Mais clareza, mais confiança e menos culpa para cuidar da saúde.`
- CTA sugerido: `Cuidar com mais clareza`
- Objetivo: Conectar com benefício emocional e clareza.
- Impulsionar depois: `não`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/09-quer-saber-o-que-faz-sentido-pra-voce.jpg`
- Fonte: `public/images/emagrecimento/medvi/hero-secondary.webp`
- Categoria: `PRÓXIMO PASSO`
- Título na arte: `Quer saber o que faz sentido pra você?`
- Subtítulo na arte: `Comece pela triagem e receba um direcionamento inicial com privacidade.`
- CTA sugerido: `Fazer minha triagem`
- Objetivo: CTA principal do grid inicial.
- Impulsionar depois: `sim`
...
- Arquivo final: `codex-artifacts/social-launch/final-posts/10-nem-todo-caso-precisa-da-mesma-estrategia.jpg`
- Fonte: `public/images/emagrecimento/medvi/reviews-07.webp`
- Objetivo: Post extra para continuidade após o grid inicial.
